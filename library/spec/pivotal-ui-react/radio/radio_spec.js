...
describe('Radio', function() {
  ...
  describe('when disabled property is passed', () => {
    ...
    it('renders label with visual indicators of disablement', () => {
      expect('#root .radio label').toHaveClass('type-neutral-5');
      expect('#root .radio label').toHaveCss({cursor:'not-allowed'});
    });
  });
