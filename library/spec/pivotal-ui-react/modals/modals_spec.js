...
import {findAllByClass, findByClass} from '../spec_helper'

describe('Modals', () => {
  const renderComponent = props => ReactTestUtils.renderIntoDocument(<Modal {...props}>Hi</Modal>)

  it('is closed by default', () => {
    expect(findAllByClass(renderComponent(), 'modal-wrapper')).toHaveLength(0)
  })
  ...
  describe('#open', () => {
    it('opens the modal', () => {
      ...
      expect(findByClass(renderComponent(), 'modal-wrapper')).toBeDefined()
    })
  })
