...
describe('Flyout', () => {
  ...
  it('renders an icon button', () => {
    expect('.pui-flyout-icon-btn').toHaveClass('pui-btn--default');
    expect('.pui-flyout-icon-btn').toHaveClass('pui-btn--flat');
    expect('.pui-flyout-icon-btn').toHaveClass('pui-btn--icon-only');
