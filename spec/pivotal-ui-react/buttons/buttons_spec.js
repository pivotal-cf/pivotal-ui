...
describe('UIButton', () => {
  ...
  describe('aria-label', () => {
    ...
    describe('when icon-only', () => {
      ...
      it('has no aria-label attribute for icon-only buttons', () => {
        expect(subject.find('.pui-btn').prop('aria-label')).toBeFalsy();
      });
    });
  ...
  describe('type', () => {
    describe('for a link', () => {
      ...
      it('has no type attribute by default', () => {
        expect(subject.find('a.pui-btn').prop('type')).toBeFalsy();
      });
    });
  ...
  describe('iconPosition', () => {
    ...
    it('renders the icon to the left by default', () => {
      expect(subject.find('.icon').next().prop('tagName')).toEqual('SPAN');
    });
    ...
    describe('is set right', () => {
      ...
      it('renders the icon to the right', () => {
        expect(subject.find('.icon').prev().prop('tagName')).toEqual('SPAN');
      });
    });
  });
});
