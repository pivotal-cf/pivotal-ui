...
describe('Panel', () => {
  ...
  describe('title', () => {
    ...
    it('renders the title', () => {
      expect('.pui-panel-container > .pui-panel-title > .col:eq(0)'.text()).toBe('some title');
      expect(subject.find('.pui-panel-container > .pui-panel-title > .col:eq(0)').hasClass('h5')).toBeTruthy();
      expect(subject.find('.pui-panel-container > .pui-panel-title > .col:eq(0)').hasClass('em-high')).toBeTruthy();
      expect(subject.find('.pui-panel-container > .pui-panel-title > .col:eq(0)').hasClass('type-ellipsis')).toBeTruthy();
      expect(subject.find('.pui-panel-container > .pui-panel-title > .col:eq(0)').hasClass('col-middle')).toBeTruthy();
    });
  ...
  describe('titleCols', () => {
    ...
    it('renders the title cols', () => {
      ...
      expect('.pui-panel-container > .pui-panel-title > .col:eq(0)'.text()).toBe('Col 1');
      expect('.pui-panel-container > .pui-panel-title > .col:eq(1)'.text()).toBe('Col 2');
    });
    ...
    describe('with a title', () => {
      ...
      it('renders the title before the title cols', () => {
        ...
        expect('.pui-panel-container > .pui-panel-title > .col:eq(0)'.text()).toBe('My Title');
        expect('.pui-panel-container > .pui-panel-title > .col:eq(1)'.text()).toBe('Col 1');
        expect('.pui-panel-container > .pui-panel-title > .col:eq(2)'.text()).toBe('Col 2');
      });
    });
  });
  ...
  describe('header', () => {
    ...
    it('renders the header', () => {
      expect('.pui-panel > .pui-panel-header > .col:eq(0)'.text()).toBe('some header');
      expect(subject.find('.pui-panel > .pui-panel-header > .col:eq(0)').hasClass('type-ellipsis')).toBeTruthy();
      expect(subject.find('.pui-panel > .pui-panel-header > .col:eq(0)').hasClass('em-high')).toBeTruthy();
      expect(subject.find('.pui-panel > .pui-panel-header > .col:eq(0)').hasClass('col-middle')).toBeTruthy();
    });
  ...
  describe('headerCols', () => {
    ...
    it('renders the header cols', () => {
      ...
      expect('.pui-panel > .pui-panel-header > .col:eq(0)'.text()).toBe('Col 1');
      expect('.pui-panel > .pui-panel-header > .col:eq(1)'.text()).toBe('Col 2');
    });
    ...
    describe('with a header', () => {
      ...
      it('renders the header before the header cols', () => {
        ...
        expect('.pui-panel > .pui-panel-header > .col:eq(0)'.text()).toBe('My Header');
        expect('.pui-panel > .pui-panel-header > .col:eq(1)'.text()).toBe('Col 1');
        expect('.pui-panel > .pui-panel-header > .col:eq(2)'.text()).toBe('Col 2');
      });
    });
  });
