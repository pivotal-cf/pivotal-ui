...
describe('Wizard', () => {
  ...
  describe('when on the first page', () => {
    ...
    describe('with cancel callback', () => {
      ...
      it('renders a cancel button', () => {
        expect('.wizard-cancel-btn.btn-primary-alt').toHaveText('Cancel');
      });
      ...
      describe('with custom cancel text', () => {
        ...
        it('renders a cancel button with custom text', () => {
          expect('.wizard-cancel-btn.btn-primary-alt').toHaveText('Close');
        });
      });
    });
    ...
    it('renders a "next" PrimaryButton', () => {
      expect('.wizard-next-btn.btn-primary').toHaveText('Next');
    });
    ...
    describe('with custom next text', () => {
      ...
      it('renders the custom text', () => {
        expect('.wizard-next-btn.btn-primary').toHaveText('customNext');
      });
    });
    ...
    describe('when the "enableNext" is false', () => {
      ...
      it('disables the "next" button', () => {
        expect('.wizard-next-btn.btn-primary').toHaveAttr('disabled');
      });
    });
  });
  ...
  describe('when on the last page', () => {
    ...
    it('renders a "back" alt PrimaryButton', () => {
      expect('.wizard-back-btn.btn-primary-alt').toHaveText('Back');
    });
    ...
    describe('with custom finish text', () => {
      ...
      it('renders the custom text', () => {
        expect('.wizard-finish-btn.btn-primary').toHaveText('customFinish');
      });
    });
